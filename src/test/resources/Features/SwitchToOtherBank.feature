@SwitchToOtherBank
Feature: SwitchToOtherBank

  @SwitchToOtherBank @SmokeEid1
  Scenario: Add new employee with kamelpay Payd card and Switch To Other Bank for the employee
   ...
   # Then    [Add Employer] user select the nationality "Afghanistan"
    ...
    When    [Switch To Other Bank] User select the bank "Ajman Bank"
